...
/**
  ...
  * @author Curt Arnold
  * @since 1.1 */
public class ConsoleAppenderX extends RepeatKillerAppender {
  ...
  public ConsoleAppenderX() {
     ...
     */
  public ConsoleAppenderX(Layout layout) {
     ...
     */
  public ConsoleAppenderX(Layout layout, String target) {
    setLayout(layout);
    setTarget(target);
    activateOptions();
  }
